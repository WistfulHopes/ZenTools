...
private:
	...
	FPackageIndex CreateExternalPackageObjectReference( const uint64 PackageId, const FPackageObjectIndex& PackageExportIndex, FAssetSerializationContext& Context ) const;
